...
import { TaskType, Priority, SubTask, Course } from '../types';
...
const CreateTask: React.FC<CreateTaskProps> = ({ onSave, onCancel, courses }) => {
                            ...
                            <div className="flex gap-2">
                                {Object.values(Priority).map(p => (
                                    <button
                                        ...
                                        className={`flex-1 py-2 rounded-lg text-xs font-medium transition-all border ${priority === p
