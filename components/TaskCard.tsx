...
export const TaskCard: React.FC<TaskCardProps> = ({ task, onStatusChange, onDelete }) => {
  ...
  return (
    <div className="group bg-white rounded-3xl p-6 border border-primary-100 hover:border-primary-300 transition-all duration-300 hover:shadow-xl hover:shadow-primary-900/5 hover:-translate-y-1 flex flex-col h-full">
